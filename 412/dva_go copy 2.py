...
class dva_go():
    ...
    def update_block(self,plate):
        ...
        for pos_1d,flag in enumerate(plate):
            if(flag):
                same_flag_neighbor_set= self.get_filter_neighbor(pos_1d,flag)   # 选出同色的邻居
    ...
    def pre_pick_up(self,new_go,new_go_flag):
        # 输出击杀信息
        ...
        plate = copy.deepcopy(self.plate)   # 虚拟棋盘
    ...
    def random_pos(self):
        ...
        pos_1d = random.randint(-1,len(self.plate)-1)
        return pos_1d
    ...
    def pick_b(self,pos_1d,flag):
        ...
        if(self.pos_legal_1d(pos_1d)):
            ...
            if(that_flag>=1):
                ...
                # 判断是否禁入，如果禁入，则也判为-1
                rec = pos_1d
                dead_set = self.pre_pick_up(pos_1d,flag)
                print('ds',dead_set)
    ...
    def liuqiudate(self,conpensate,plate):

        winner = -1

        ta = self.count_territory(1,plate)
        tb = self.count_territory
    ...
    def __init__(self,show_game):
        ...
        while(1):
            ...
            flag = 1
            while(1):
                pos_1d = self.random_pos()

                dead_set = self.pick_b(pos_1d,flag)
                ...
                if(self.is_terminal()):
                    ...
                    print(self.record)
                    time.sleep(1000)
                    winner = self.liquidate(tiemu,plate)
