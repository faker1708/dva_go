...
class dva_go():
    ...
    def random_pos(self,flag,plate):
        ...
        territory_self = 0
        # territory_opponent = 0

        go_connt = 0
        for _,ele in enumerate(plate):
            if(ele == flag):
                go_connt+=1
        ...
        # territory_self =self.count_territory(flag,plate)
        # territory_opponent =self.count_territory(opponent,plate)

        # if(flag )
        # if( territory_self  > 180 + 0.5):
        if(go_connt>180):
            pos_1d = -1
    ...
    def __init__(self):
        ...
        # 显示画面
        self.show_game = 1
        battale_mode = 2   # 0 机机 1 人机 2 人人

        if(self.show_game==0):  # 不开屏幕，人不能玩游戏
            battale_mode = 0
        ...
        while(1):
            ...
            while(1):
                ...
                if(self.show_game):
                    ...
                    if(battale_mode==1 or battale_mode==2):
                        if(flag==1):
